...
export default function Main() {
	...
	return (
		<div>
			...
			<p>
				Alcohol is a poison. It is not good for you and can easily harm you. See
				below for more information. This app enables you to see how many units
				of alcohol you may be consuming and how this compares to what is safe.
			</p>
			<p>
			...
			<p>
				...
				around 6 standard glasses (175ml) of 13.5% wine.)
			</p>
			<p>
				Previously the guidelines were 14 units of alcohol a week for women and
				21 for men.
			</p>
			<p>
			...
			<p>
				...
				very quickly. The risks of short-term harm like accidents or injuries
